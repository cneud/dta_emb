...
<xsl:param name="show_page_numbers">0</xsl:param>
<!-- show or hide !!FORMFEED!! -->
<xsl:param name="show_form_feed">0</xsl:param>
...
<xsl:param name="show_sig_in_bogensignatur">0</xsl:param>
<xsl:param name="show_sig_in_kolumnentitel">0</xsl:param>
<xsl:param name="show_line_numbers">0</xsl:param>
<xsl:param name="show_bogensignatur">0</xsl:param>
<xsl:param name="show_kolumnentitel">0</xsl:param>
<xsl:param name="show_catchword">0</xsl:param>
<xsl:param name="show_newlines_in_cells">0</xsl:param>
<!-- Typographical or authentic footnote sigils -->
<xsl:param name="use_authentic_footnote_sign">0</xsl:param>
